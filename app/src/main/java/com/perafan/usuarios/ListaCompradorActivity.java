...
public class ListaCompradorActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Aqui obtengo el id del cliente que esta haciendo la compra
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            //listShopAdapter adapter = new listShopAdapter(ListaCompradorActivity.this,songList,eTCant,carroCompras,fabVerCart, id); //ojo por si hay que devolverse
